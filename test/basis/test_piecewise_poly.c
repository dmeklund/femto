...
//    struct Fto2DPoint pt1 = {.x = 0, .y = 0};
//    struct Fto2DPoint pt2 = {.x = 0, .y = 1};
//    struct Fto2DPoint pt3 = {.x = 1, .y = 0};
    ...
    double val;
    const struct Fto2DPoint points[] = {triangle->point1, triangle->point2, triangle->point3};
